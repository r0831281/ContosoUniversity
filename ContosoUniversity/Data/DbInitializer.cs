...
namespace ContosoUniversity.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            new Student{FirstMidName="Yan",LastName="Li",EnrollmentDate=DateTime.Parse("2020-09-01")},
            ...
            new Student{FirstMidName="Nino",LastName="Olivetto",EnrollmentDate=DateTime.Parse("2018-09-01")}
            };
